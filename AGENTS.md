...
│   └── AGENTS.md             # Go-specific build/architecture/patterns
...
See `feedsystem_video_go/AGENTS.md` for Go-specific build commands, architecture, core patterns, and testing. Quick start:
